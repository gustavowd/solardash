...
with tab2:
    ...
    for m in multi_month:
        ...
        if chart_data.empty:
            ...
            #df = conn.query("select day,max(measurement_value) from measurements natural join time where device_id=" + str(device_id) + " and measurement_type_id=7 and measurement_time between '2024-05-14 00:00:01' and '2024-05-14 23:59:59' group by day order by day", ttl=0)
