...
setup_page('Medidores', 'Acompanhe as medições de energia dos blocos e instalações do campus.')
...
df_m = conn.query("select measurement_name, measurement_type_id from measurements natural join measurement_type where device_id=3 and measurement_time between '2024-05-09 08:00:01' and '2024-05-09 08:00:15' order by measurement_type_id")
